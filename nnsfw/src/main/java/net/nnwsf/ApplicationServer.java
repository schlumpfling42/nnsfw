...
public class ApplicationServer {
    ...
    private ApplicationServer(Class<?> applicationClass) {
        ...
        Server serverConfiguration = Reflection.getInstance().findAnnotation(applicationClass, Server.class);
        ...
        Datasource datasource = Reflection.getInstance().findAnnotation(applicationClass, Datasource.class);
